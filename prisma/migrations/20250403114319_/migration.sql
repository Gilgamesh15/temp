...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('mention', 'followRequestRecieved', 'followRequestAccepted', 'followThreshold', 'like', 'likeThreshold', 'comment', 'commentThreshold', 'block', 'unblock', 'birthday');
